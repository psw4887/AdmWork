...
public class QHouseholdCompositionResident extends EntityPathBase<HouseholdCompositionResident> {
    ...
    private static final long serialVersionUID = 404908189L;
    ...
    public final StringPath compositionChangeReasonCode = createString("compositionChangeReasonCode");

    public final QHousehold household;

    public final QHouseholdCompositionResident_HouseholdCompositionResidentPK householdCompositionResidentPK;

    public final StringPath relationshipCode = createString("relationshipCode");
    ...
    public QHouseholdCompositionResident(Class<? extends HouseholdCompositionResident> type, PathMetadata metadata, PathInits inits) {
        ...
        this.householdCompositionResidentPK = inits.isInitialized("householdCompositionResidentPK") ? new QHouseholdCompositionResident_HouseholdCompositionResidentPK(forProperty("householdCompositionResidentPK")) : null;
